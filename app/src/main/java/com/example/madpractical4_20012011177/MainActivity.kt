package com.example.madpractical4_20012011177
...
import com.example.madpractical4_20012011177.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonBrowse.setOnClickListener{
            ...
            Intent(Intent.ACTION_VIEW).setData(Uri.parse(url_text)).apply { startActivity(intent) }
        }
